...
>
    ...
    <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="" class="flex items-center px-2 py-2 text-sm font-medium rounded-md group">
            <svg class="w-6 h-6 mr-3  ? 'text-cyan-300' : 'text-gray-400 group-hover:text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
