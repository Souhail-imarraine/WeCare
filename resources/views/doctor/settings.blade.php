        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between mb-6 lg:mb-8">
                ...
                <a href="{{ route('doctor.profile') }}"
                    class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                ...
                                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                    <div class="w-32 h-32 rounded-xl overflow-hidden bg-gray-100 ring-4 ring-gray-50">
                                        <img src="{{ asset($doctor->profile_image ?? 'doctor_profile/default-avatar.png') }}"
                                            alt="Profile picture" class="w-full h-full object-cover" id="profile-preview">
                                    </div>
                                    <div class="flex flex-col gap-3 flex-grow">
                                        <div class="flex flex-wrap gap-3">
                                            ...
                                            <label for="profile_photo"
                                                class="inline-flex items-center px-4 py-2 bg-cyan-500 text-white rounded-md hover:bg-cyan-600 text-sm font-medium cursor-pointer transition-colors">
                                        ...
                                        <button type="submit" name="action" value="delete_photo"
                                            class="inline-flex items-center px-4 py-2 bg-red-50 text-red-600 rounded-md hover:bg-red-100 text-sm font-medium transition-colors self-start">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea name="bio" rows="4"
                                            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm"
                                            placeholder="Write a few sentences about yourself">{{ old('bio', $doctor->bio) }}</textarea>
                                        @error('bio')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
